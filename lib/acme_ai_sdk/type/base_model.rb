  ...
  module Type
    ...
    class BaseModel
      ...
      class << self
        ...
        #
        # @param type_info [Hash{Symbol=>Object}, Proc, AcmeAISDK::Type::Converter, Class]
        #
        ...
        private def add_field(name_sym, required:, type_info:, spec:)
          type_fn, info =
            case type_info
            in Proc | AcmeAISDK::Type::Converter | Class
              [AcmeAISDK::Type::Converter.type_info({**spec, union: type_info}), spec]
            in Hash
              [AcmeAISDK::Type::Converter.type_info(type_info), type_info]
            end
          ...
          define_method(name_sym) do
            ...
            if (nilable || !required) && value.nil?
              ...
              AcmeAISDK::Type::Converter.coerce(
                target,
                value,
                state: state
              )
        ...
        def coerce(value, state:)
          ...
          fields.each do |name, field|
            ...
            unless val.key?(api_name)
              if required && mode != :dump && const == AcmeAISDK::Util::OMIT
            ...
            converted =
              if item.nil? && (nilable || !required)
                ...
                coerced = AcmeAISDK::Type::Converter.coerce(target, item, state: state)
                case target
                in AcmeAISDK::Type::Converter | Symbol
                  coerced
                else
                  item
                end
          ...
          coerced.each do |key, val|
            ...
            in nil
              ...
              in :coerce
                ...
                target = type_fn.call
                acc.store(api_name, AcmeAISDK::Type::Converter.dump(target, val))
              end
            end
          end
