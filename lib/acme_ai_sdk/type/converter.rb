    ...
    module Converter
      ...
      class << self
        ...
        def type_info(spec)
          ...
          in AcmeAISDK::Type::Converter | Class | Symbol
            -> { spec }
        ...
        #
        # @param target [AcmeAISDK::Type::Converter, Class]
        #
        # @param value [Object]
        #
        ...
        def dump(target, value)
          target.is_a?(AcmeAISDK::Type::Converter) ? target.dump(value) : AcmeAISDK::Unknown.dump(value)
        end
      end
    end
