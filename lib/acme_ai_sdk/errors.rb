...
module AcmeAISDK
  module Errors
    ...
    class APIStatusError < AcmeAISDK::Errors::APIError
      ...
      # @param message [String, nil]
      #
      # @return [AcmeAISDK::Errors::APIStatusError]
      def self.for(url:, status:, body:, request:, response:, message: nil)
        ...
        case status
        in 400
          AcmeAISDK::Errors::BadRequestError.new(**kwargs)
        in 401
          AcmeAISDK::Errors::AuthenticationError.new(**kwargs)
        in 403
          AcmeAISDK::Errors::PermissionDeniedError.new(**kwargs)
        in 404
          AcmeAISDK::Errors::NotFoundError.new(**kwargs)
        in 409
          AcmeAISDK::Errors::ConflictError.new(**kwargs)
        in 422
          AcmeAISDK::Errors::UnprocessableEntityError.new(**kwargs)
        in 429
          AcmeAISDK::Errors::RateLimitError.new(**kwargs)
        in (500..)
          AcmeAISDK::Errors::InternalServerError.new(**kwargs)
        else
          AcmeAISDK::Errors::APIStatusError.new(**kwargs)
        end
      end
