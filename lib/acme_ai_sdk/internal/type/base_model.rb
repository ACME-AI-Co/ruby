    ...
    module Type
      ...
      class BaseModel
        ...
        class << self
          ...
          #
          # @param child [Class<AcmeAISDK::Internal::Type::BaseModel>]
          def inherited(child)
            super
          ...
          #
          # @param type_info [Hash{Symbol=>Object}, Proc, AcmeAISDK::Internal::Type::Converter, Class]
          #
          ...
          private def add_field(name_sym, required:, type_info:, spec:)
            type_fn, info =
              case type_info
              in Proc | AcmeAISDK::Internal::Type::Converter | Class
                [AcmeAISDK::Internal::Type::Converter.type_info({**spec, union: type_info}), spec]
              in Hash
                [AcmeAISDK::Internal::Type::Converter.type_info(type_info), type_info]
              end
            ...
            define_method(name_sym) do
              ...
              if (nilable || !required) && value.nil?
                ...
                AcmeAISDK::Internal::Type::Converter.coerce(
        ...
        class << self
          ...
          def coerce(value, state:)
            ...
            unless (val = AcmeAISDK::Internal::Util.coerce_hash(value)).is_a?(Hash)
              exactness[:no] += 1
              return value
            end
            exactness[:yes] += 1
            ...
            fields.each do |name, field|
              ...
              converted =
                if item.nil? && (nilable || !required)
                  ...
                  coerced = AcmeAISDK::Internal::Type::Converter.coerce(target, item, state: state)
                  case target
                  in AcmeAISDK::Internal::Type::Converter | Symbol
                    coerced
                  else
                    item
                  end
          ...
          def dump(value, state:)
            unless (coerced = AcmeAISDK::Internal::Util.coerce_hash(value)).is_a?(Hash)
              return super
            end
            ...
            coerced.each do |key, val|
              ...
              in nil
                ...
                in :coerce
                  ...
                  target = type_fn.call
                  acc.store(api_name, AcmeAISDK::Internal::Type::Converter.dump(target, val, state: state))
                end
              end
            end
            ...
            rec = ->(x) do
              ...
              in AcmeAISDK::Internal::Type::BaseModel
                if convert
                  ...
                  rescue AcmeAISDK::Errors::ConversionError
                    [key, rec.call(val)]
                  end
                else
                  rec.call(x.to_h)
        ...
        #
        # @return [String]
        def to_json(*a) = AcmeAISDK::Internal::Type::Converter.dump(self.class, self).to_json(*a)
        ...
        #
        # @return [String]
        def to_yaml(*a) = AcmeAISDK::Internal::Type::Converter.dump(self.class, self).to_yaml(*a)
        ...
        class << self
          ...
          def inspect(depth: 0)
            ...
            deferred = fields.transform_values do |field|
              ...
              inspected = [
                AcmeAISDK::Internal::Type::Converter.inspect(type, depth: depth),
