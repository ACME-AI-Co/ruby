    ...
    module Transport
      ...
      class BaseClient
        ...
        def initialize(
          ...
          @base_url_components = AcmeAISDK::Internal::Util.parse_uri(base_url)
          @base_url = AcmeAISDK::Internal::Util.unparse_uri(@base_url_components)
        ...
        private def build_request(req, opts)
          ...
          url = AcmeAISDK::Internal::Util.join_parsed_uri(
            @base_url_components,
