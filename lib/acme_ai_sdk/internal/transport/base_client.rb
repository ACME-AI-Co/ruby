  ...
  module Internal
    module Transport
      ...
      class BaseClient
        ...
        PLATFORM_HEADERS =
          {
            "x-stainless-arch" => AcmeAISDK::Internal::Util.arch,
            "x-stainless-lang" => "ruby",
            "x-stainless-os" => AcmeAISDK::Internal::Util.os,
            "x-stainless-package-version" => AcmeAISDK::VERSION,
        ...
        class << self
          ...
          def should_retry?(status, headers:)
            coerced = AcmeAISDK::Internal::Util.coerce_boolean(headers["x-should-retry"])
            case [coerced, status]
            in [true | false, _]
              coerced
          ...
          def follow_redirect(request, status:, response_headers:)
            ...
            # from undici
            if AcmeAISDK::Internal::Util.uri_origin(url) != AcmeAISDK::Internal::Util.uri_origin(location)
          ...
          def reap_connection!(status, stream:)
            ...
            in AcmeAISDK::Errors::APIConnectionError | (500..)
              AcmeAISDK::Internal::Util.close_fused!(stream)
            else
            end
          end
        end
        ...
        def initialize(
          ...
          @requester = AcmeAISDK::Internal::Transport::PooledNetRequester.new
          @headers = AcmeAISDK::Internal::Util.normalized_headers(
          ...
          @base_url = AcmeAISDK::Internal::Util.parse_uri(base_url)
        ...
        private def build_request(req, opts)
          ...
          path = AcmeAISDK::Internal::Util.interpolate_path(uninterpolated_path)

          query = AcmeAISDK::Internal::Util.deep_merge(req[:query].to_h, opts[:extra_query].to_h)
          ...
          body =
            ...
            in :get | :head | :options | :trace
              ...
              AcmeAISDK::Internal::Util.deep_merge(*[req[:body], opts[:extra_body]].compact)
            end

          headers, encoded = AcmeAISDK::Internal::Util.encode_content(headers, body)
          {
            method: method,
            url: AcmeAISDK::Internal::Util.join_parsed_uri(@base_url, {**req, path: path, query: query}),
            headers: headers,
            body: encoded,
        ...
        private def send_request(request, redirect_count:, retry_count:, send_retry_header:)
          ...
          input = {**request.except(:timeout), deadline: AcmeAISDK::Internal::Util.monotonic_secs + timeout}
          ...
          in AcmeAISDK::Errors::APIConnectionError if retry_count >= max_retries
            raise status
          in (400..) if retry_count >= max_retries || !self.class.should_retry?(status, headers: response)
            decoded = Kernel.then do
              AcmeAISDK::Internal::Util.decode_content(response, stream: stream, suppress_error: true)
            ensure
              self.class.reap_connection!(status, stream: stream)
            end
        ...
        # methods call into.
        #
        # @overload request(method, path, query: {}, headers: {}, body: nil, unwrap: nil, page: nil, stream: nil, model: AcmeAISDK::Internal::Type::Unknown, options: {})
        #
        # @param method [Symbol]
        #
        ...
        #
        # @param options [AcmeAISDK::RequestOptions, Hash{Symbol=>Object}, nil] .
        #
        ...
        def request(req)
          ...
          model = req.fetch(:model) { AcmeAISDK::Internal::Type::Unknown }
          opts = req[:options].to_h
          AcmeAISDK::RequestOptions.validate!(opts)
          ...
          decoded = AcmeAISDK::Internal::Util.decode_content(response, stream: stream)
          case req
          in {stream: Class => st}
          ...
          in {page: Class => page}
            ...
            unwrapped = AcmeAISDK::Internal::Util.dig(decoded, req[:unwrap])
            AcmeAISDK::Internal::Type::Converter.coerce(model, unwrapped)
          end
        end
        ...
        def inspect
          ...
          base_url = AcmeAISDK::Internal::Util.unparse_uri(@base_url)
          ...
          T.type_alias do
            {
              ...
              options: T.nilable(AcmeAISDK::RequestOptions::OrHash)
            }
          end
        end
