...
module AcmeAISDK
  ...
  module Util
    ...
    #   structure when using `AcmeAISDK::Util.deep_merge`.
    #
    ...
    class << self
      ...
      sig do
        params(
          data: T.any(AcmeAISDK::Util::AnyHash, T::Array[T.anything], T.anything),
    ...
    class << self
      # @api private
      sig { params(url: T.any(URI::Generic, String)).returns(AcmeAISDK::Util::ParsedUriShape) }
      def parse_uri(url)
      end

      # @api private
      sig { params(parsed: AcmeAISDK::Util::ParsedUriShape).returns(URI::Generic) }
      ...
      sig do
        params(
          lhs: AcmeAISDK::Util::ParsedUriShape,
          rhs: AcmeAISDK::Util::ParsedUriShape
        ).returns(URI::Generic)
      end
    ...
    class << self
      ...
      sig { params(lines: T::Enumerable[String]).returns(AcmeAISDK::Util::ServerSentEvent) }
