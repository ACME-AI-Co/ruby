  ...
  module Internal
    module Type
      ...
      module Union
        ...
        sig do
          params(
            key: T.any(Symbol, AcmeAISDK::Internal::AnyHash, T.proc.returns(T.anything), T.anything),
            spec: T.any(AcmeAISDK::Internal::AnyHash, T.proc.returns(T.anything), T.anything)
          )
            .void
        end
