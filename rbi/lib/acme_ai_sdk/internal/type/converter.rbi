...
module AcmeAISDK
  module Internal
    module Type
      # @api private
      module Converter
        Input = T.type_alias { T.any(AcmeAISDK::Internal::Type::Converter, T::Class[T.anything]) }
        ...
        sig do
          overridable
            .params(value: T.anything, state: AcmeAISDK::Internal::Type::Converter::State)
            .returns(T.anything)
        end
        ...
        class << self
              ...
              spec: T.any(
                {
                  ...
                  enum: T.nilable(T.proc.returns(AcmeAISDK::Internal::Type::Converter::Input)),
                  union: T.nilable(T.proc.returns(AcmeAISDK::Internal::Type::Converter::Input))
                },
          ...
          sig do
            params(
              target: AcmeAISDK::Internal::Type::Converter::Input,
              value: T.anything,
          ...
          # @api private
          sig do
            params(target: AcmeAISDK::Internal::Type::Converter::Input, value: T.anything).returns(T.anything)
          end
