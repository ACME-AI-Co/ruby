...
module AcmeAISDK
  module Internal
    ...
    module Util
      ...
      #   structure when using `AcmeAISDK::Internal::Util.deep_merge`.
      #
      ...
      class << self
        ...
        sig do
          params(
            data: T.any(AcmeAISDK::Internal::Util::AnyHash, T::Array[T.anything], T.anything),
      ...
      class << self
        # @api private
        sig { params(url: T.any(URI::Generic, String)).returns(AcmeAISDK::Internal::Util::ParsedUriShape) }
        def parse_uri(url)
        end

        # @api private
        sig { params(parsed: AcmeAISDK::Internal::Util::ParsedUriShape).returns(URI::Generic) }
        ...
        sig do
          params(
            lhs: AcmeAISDK::Internal::Util::ParsedUriShape,
            rhs: AcmeAISDK::Internal::Util::ParsedUriShape
          )
            .returns(URI::Generic)
        end
      ...
      class << self
        ...
        sig { params(lines: T::Enumerable[String]).returns(AcmeAISDK::Internal::Util::ServerSentEvent) }
