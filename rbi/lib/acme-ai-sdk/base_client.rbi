...
module AcmeAISDK
  ...
  class BaseClient
      ...
      T.type_alias do
        {
          ...
          page: T.nilable(T::Class[AcmeAISDK::BasePage[AcmeAISDK::BaseModel]]),
          stream: T.nilable(T::Class[T.anything]),
          model: T.nilable(AcmeAISDK::Converter::Input),
    ...
    class << self
      # @api private
      sig { params(req: AcmeAISDK::BaseClient::RequestComponentsShape).void }
      def validate!(req)
      end
      ...
      sig do
        params(
          request: AcmeAISDK::BaseClient::RequestInputShape,
          status: Integer,
          response_headers: T.any(T::Hash[String, String], Net::HTTPHeader)
        )
          .returns(AcmeAISDK::BaseClient::RequestInputShape)
      end
    ...
    sig do
      overridable
        .params(req: AcmeAISDK::BaseClient::RequestComponentsShape, opts: AcmeAISDK::Util::AnyHash)
        .returns(AcmeAISDK::BaseClient::RequestInputShape)
    end
