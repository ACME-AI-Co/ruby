...
module AcmeAISDK
  ...
  module RequestParameters
    ...
    sig { returns(T.any(AcmeAISDK::RequestOptions, AcmeAISDK::Util::AnyHash)) }
    attr_accessor :request_options

    # @api private
    module Converter
      # @api private
      sig { params(params: T.anything).returns([T.anything, AcmeAISDK::Util::AnyHash]) }
  ...
  class RequestOptions < AcmeAISDK::BaseModel
    ...
    sig { params(values: AcmeAISDK::Util::AnyHash).returns(T.attached_class) }
    def self.new(values = {})
    end
  end
end
