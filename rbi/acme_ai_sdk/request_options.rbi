...
module AcmeAISDK
  RequestOpts = T.type_alias { T.any(AcmeAISDK::RequestOptions, AcmeAISDK::Internal::AnyHash) }
  ...
  class RequestOptions < AcmeAISDK::Internal::Type::BaseModel
    ...
    sig { params(values: AcmeAISDK::Internal::AnyHash).returns(T.attached_class) }
