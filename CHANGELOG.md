...
* **api:** update via SDK Studio ([1a5aa0e](https://github.com/ACME-AI-Co/ruby/commit/1a5aa0e1637a082847c340ced2d3bcf5b201c413))
* **api:** update via SDK Studio ([eab4cd9](https://github.com/ACME-AI-Co/ruby/commit/eab4cd9ac4f4eaa87001b2fd73cc816e75fe44c6))
* bump default connection pool size limit to minimum of 99 ([0c3560d](https://github.com/ACME-AI-Co/ruby/commit/0c3560d391b1c99ee9d2350d6ca3177cb6b49a83))
...
* expose base client options as read only attributes ([de10e71](https://github.com/ACME-AI-Co/ruby/commit/de10e718d68adc90fdaee337375fc11d6709f74c))
* expose recursive `#to_h` conversion ([ce05803](https://github.com/ACME-AI-Co/ruby/commit/ce05803aed110e3cdb0ec9fe9da823c7526d9a41))
...
* support sorbet aliases at the runtime ([3f35fec](https://github.com/ACME-AI-Co/ruby/commit/3f35fec99f15ce64ae9fd33cca9be4617db29591))
...
* correctly instantiate sorbet type aliases for enums and unions ([1c7c688](https://github.com/ACME-AI-Co/ruby/commit/1c7c68855c199ea89ae049e9b67e1e0af28a83cc))
...
* **internal:** update gemspec name ([26ba93d](https://github.com/ACME-AI-Co/ruby/commit/26ba93d4edb241cccb1d66d3f9004bae5cf4eb69))
...
* prevent rubocop from mangling `===` to `is_a?` check ([6e1d39b](https://github.com/ACME-AI-Co/ruby/commit/6e1d39be7a71e89ee76a0d3aeee0a54133dd1ed3))
...
* **docs:** grammar improvements ([76fbccf](https://github.com/ACME-AI-Co/ruby/commit/76fbccffab0c33a4736e781386a92abdb00a108c))
...
* fix misc linting / minor issues ([68b0f67](https://github.com/ACME-AI-Co/ruby/commit/68b0f6784cbef30a283fa41ea1095ca8ad48a341))
...
* force utf-8 locale via `RUBYOPT` when formatting ([6a78e32](https://github.com/ACME-AI-Co/ruby/commit/6a78e321b588b035ac2d25943fc9096c99c996b3))
...
* refine Yard and Sorbet types and ensure linting is turned on for examples ([1ccdf3b](https://github.com/ACME-AI-Co/ruby/commit/1ccdf3b987025bd60c46ebfe4fc18dfb2d9805bb))
...
* use fully qualified names for yard annotations and rbs aliases ([31d3026](https://github.com/ACME-AI-Co/ruby/commit/31d3026830ee93e1c0c818691b07bc77b2f7c7ec))
...
* whitespaces ([80f8e54](https://github.com/ACME-AI-Co/ruby/commit/80f8e54cceb0c46325f50b8fb522404ec5bf2459))
...
* rewrite much of README.md for readability ([1b92c7a](https://github.com/ACME-AI-Co/ruby/commit/1b92c7a7491c66ceaa9434702b596d39c975cc31))
