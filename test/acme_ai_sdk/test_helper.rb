...
class AcmeAISDK::Test::SingletonClient < AcmeAISDK::Client
  include Singleton

  TEST_API_BASE_URL = ENV.fetch("TEST_API_BASE_URL", "http://localhost:4010")

  def initialize
    super(base_url: AcmeAISDK::Test::SingletonClient::TEST_API_BASE_URL, bearer_token: "My Bearer Token")
  end
end
...
class AcmeAISDK::Test::ResourceTest < Minitest::Test
  def async?
  ...
  def before_all
    super
    @acme_ai_sdk = AcmeAISDK::Test::SingletonClient.instance
  end
