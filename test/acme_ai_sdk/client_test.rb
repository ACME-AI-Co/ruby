...
class AcmeAISDKTest < Minitest::Test
  ...
  def test_client_default_request_default_retry_attempts
    stub_request(:post, "http://localhost/files/").to_return_json(status: 500, body: {})

    acme_ai_sdk = AcmeAISDK::Client.new(base_url: "http://localhost", bearer_token: "My Bearer Token")

    assert_raises(AcmeAISDK::Errors::InternalServerError) do
      acme_ai_sdk.files.file_create(file: Pathname(__FILE__))
    end
  ...
  def test_client_given_request_default_retry_attempts
    ...
    acme_ai_sdk =
      AcmeAISDK::Client.new(base_url: "http://localhost", bearer_token: "My Bearer Token", max_retries: 3)
  ...
  def test_client_default_request_given_retry_attempts
    ...
    assert_raises(AcmeAISDK::Errors::InternalServerError) do
      acme_ai_sdk.files.file_create(file: Pathname(__FILE__), request_options: {max_retries: 3})
    end
  ...
  def test_client_given_request_given_retry_attempts
    ...
    assert_raises(AcmeAISDK::Errors::InternalServerError) do
      acme_ai_sdk.files.file_create(file: Pathname(__FILE__), request_options: {max_retries: 4})
    end
  ...
  def test_client_retry_after_seconds
    stub_request(:post, "http://localhost/files/").to_return_json(
      status: 500,
    ...
    acme_ai_sdk =
      AcmeAISDK::Client.new(base_url: "http://localhost", bearer_token: "My Bearer Token", max_retries: 1)
  ...
  def test_client_redirect_307
    ...
    assert_raises(AcmeAISDK::Errors::APIConnectionError) do
      acme_ai_sdk.files.file_create(file: Pathname(__FILE__), request_options: {extra_headers: {}})
    end

    recorded, = WebMock::RequestRegistry.instance.requested_signatures.hash.first

    assert_requested(:any, "http://localhost/redirected", times: AcmeAISDK::Client::MAX_REDIRECTS) do
  ...
  def test_client_redirect_303
    ...
    assert_requested(:get, "http://localhost/redirected", times: AcmeAISDK::Client::MAX_REDIRECTS) do
  ...
  def test_client_redirect_auth_strip_cross_origin
    ...
    assert_requested(:any, "https://example.com/redirected", times: AcmeAISDK::Client::MAX_REDIRECTS) do
      headers = _1.headers.keys.map(&:downcase)
  ...
  def test_default_headers
    stub_request(:post, "http://localhost/files/").to_return_json(status: 200, body: {})
