...
class AcmeAISDK::Test::UtilDataHandlingTest < Minitest::Test
  def test_left_map
    assert_pattern do
      AcmeAISDK::Internal::Util.deep_merge({a: 1}, nil) => nil
    end
  end

  def test_right_map
    assert_pattern do
      AcmeAISDK::Internal::Util.deep_merge(nil, {a: 1}) => {a: 1}
    end
  end

  def test_disjoint_maps
    assert_pattern do
      AcmeAISDK::Internal::Util.deep_merge({b: 2}, {a: 1}) => {a: 1, b: 2}
    end
  end

  def test_overlapping_maps
    assert_pattern do
      AcmeAISDK::Internal::Util.deep_merge({b: 2, c: 3}, {a: 1, c: 4}) => {a: 1, b: 2, c: 4}
    end
  end

  def test_nested
    assert_pattern do
      AcmeAISDK::Internal::Util.deep_merge({b: {b2: 1}}, {b: {b2: 2}}) => {b: {b2: 2}}
    end
  end

  def test_nested_left_map
    assert_pattern do
      AcmeAISDK::Internal::Util.deep_merge({b: {b2: 1}}, {b: 6}) => {b: 6}
    end
  end
  ...
  def test_dig
    assert_pattern do
      AcmeAISDK::Internal::Util.dig(1, nil) => 1
      AcmeAISDK::Internal::Util.dig({a: 1}, :b) => nil
      AcmeAISDK::Internal::Util.dig({a: 1}, :a) => 1
      AcmeAISDK::Internal::Util.dig({a: {b: 1}}, [:a, :b]) => 1

      AcmeAISDK::Internal::Util.dig([], 1) => nil
      AcmeAISDK::Internal::Util.dig([nil, [nil, 1]], [1, 1]) => 1
      AcmeAISDK::Internal::Util.dig({a: [nil, 1]}, [:a, 1]) => 1
      AcmeAISDK::Internal::Util.dig([], 1.0) => nil

      AcmeAISDK::Internal::Util.dig(Object, 1) => nil
      AcmeAISDK::Internal::Util.dig([], 1.0) { 2 } => 2
      AcmeAISDK::Internal::Util.dig([], ->(_) { 2 }) => 2
      AcmeAISDK::Internal::Util.dig([1], -> { _1 in [1] }) => true
    end
  end
end

class AcmeAISDK::Test::UtilUriHandlingTest < Minitest::Test
  def test_parsing
    %w[
      http://example.com
      https://example.com/
      ...
      parsed = AcmeAISDK::Internal::Util.parse_uri(url)
      unparsed = AcmeAISDK::Internal::Util.unparse_uri(parsed).to_s

      assert_equal(url, unparsed)
      assert_equal(parsed, AcmeAISDK::Internal::Util.parse_uri(unparsed))
    end
  end
  ...
  def test_joining
    cases = [
      [
        "h://a.b/c?d=e",
        "h://nope/ignored",
        AcmeAISDK::Internal::Util.parse_uri("h://a.b/c?d=e")
      ],
      [
        "h://a.b/c?d=e",
        "h://nope",
    ...
    cases.each do |expect, lhs, rhs|
      assert_equal(
        URI.parse(expect),
        AcmeAISDK::Internal::Util.join_parsed_uri(
          AcmeAISDK::Internal::Util.parse_uri(lhs),
          rhs
        )
      )
    end
  ...
  def test_joining_queries
    ...
    cases.each do |path, expected|
      assert_equal(
        URI.parse(expected),
        AcmeAISDK::Internal::Util.join_parsed_uri(
          AcmeAISDK::Internal::Util.parse_uri(base_url),
          {path: path}
        )
      )
    end
...
class AcmeAISDK::Test::RegexMatchTest < Minitest::Test
  def test_json_content
    ...
    cases.each do |header, verdict|
      assert_pattern do
        AcmeAISDK::Internal::Util::JSON_CONTENT.match?(header) => ^verdict
      end
    end
  end
  ...
  def test_jsonl_content
    ...
    cases.each do |header, verdict|
      assert_pattern do
        AcmeAISDK::Internal::Util::JSONL_CONTENT.match?(header) => ^verdict
      end
    end
  end
end

class AcmeAISDK::Test::UtilFormDataEncodingTest < Minitest::Test
  class FakeCGI < CGI
    def initialize(headers, io)
      encoded = io.to_a
      @ctype = headers["content-type"]
      # rubocop:disable Lint/EmptyBlock
      @io = AcmeAISDK::Internal::Util::ReadIOAdapter.new(encoded.to_enum) {}
...
class AcmeAISDK::Test::UtilIOAdapterTest < Minitest::Test
  def test_copy_read
    cases = {
      StringIO.new("abc") => "abc",
    ...
    cases.each do |input, expected|
      io = StringIO.new
      # rubocop:disable Lint/EmptyBlock
      adapter = AcmeAISDK::Internal::Util::ReadIOAdapter.new(input) {}
      # rubocop:enable Lint/EmptyBlock
  ...
  def test_copy_write
    ...
    cases.each do |input, expected|
      enum = AcmeAISDK::Internal::Util.writable_enum do |y|
...
class AcmeAISDK::Test::UtilFusedEnumTest < Minitest::Test
  def test_closing
    arr = [1, 2, 3]
    once = 0
    fused = AcmeAISDK::Internal::Util.fused_enum(arr.to_enum) do
      once = once.succ
    end
  ...
  def test_rewind_chain
    once = 0
    fused = AcmeAISDK::Internal::Util.fused_enum([1, 2, 3].to_enum) do
      once = once.succ
    end
      .lazy
      .map(&:succ)
  ...
  def test_external_iteration
    it = [1, 2, 3].to_enum
    first = it.next
    fused = AcmeAISDK::Internal::Util.fused_enum(it, external: true)
  ...
  def test_close_fused
    ...
    AcmeAISDK::Internal::Util.close_fused!(fused)
  ...
  def test_closed_fused_extern_iteration
    ...
    fused = AcmeAISDK::Internal::Util.fused_enum(enum)
    first = fused.next
  ...
  def test_close_fused_sse_chain
    ...
    fused_1 = AcmeAISDK::Internal::Util.fused_enum(enum)
    fused_2 = AcmeAISDK::Internal::Util.decode_lines(fused_1)
    fused_3 = AcmeAISDK::Internal::Util.decode_sse(fused_2)

    assert_equal(0, taken)
    AcmeAISDK::Internal::Util.close_fused!(fused_3)
    assert_equal(0, taken)
  end
end

class AcmeAISDK::Test::UtilContentDecodingTest < Minitest::Test
  def test_charset
    cases = {
    ...
    cases.each do |content_type, encoding|
      AcmeAISDK::Internal::Util.force_charset!(content_type, text: text)
      assert_equal(encoding, text.encoding)
    end
  end
end

class AcmeAISDK::Test::UtilSseTest < Minitest::Test
  def test_decode_lines
    ...
    cases.each do |enum, expected|
      eols.each do |eol|
        lines = AcmeAISDK::Internal::Util.decode_lines(enum.map { _1.gsub("\n", eol) })
  ...
  def test_mixed_decode_lines
    ...
    cases.each do |enum, expected|
      lines = AcmeAISDK::Internal::Util.decode_lines(enum)
  ...
  def test_decode_sse
    ...
    cases.each do |name, test_cases|
      test_cases.each do |input, expected|
        actual = AcmeAISDK::Internal::Util.decode_sse(input).map(&:compact)
