...
class AcmeAISDK::Test::SorbetRuntimeSupportTest < Minitest::Test
  ...
  class M < AcmeAISDK::Internal::Type::BaseModel
  ...
  def test_nil_aliases
    ...
    assert_raises(err) { AcmeAISDK::Internal::Type::BaseModel::KnownField }
    assert_raises(err) { AcmeAISDK::Internal::Util::ParsedUri }
    assert_raises(err) { AcmeAISDK::Internal::Util::ServerSentEvent }
    assert_raises(err) { AcmeAISDK::Internal::Transport::BaseClient::RequestComponents }
    assert_raises(err) { AcmeAISDK::Internal::Transport::BaseClient::RequestInput }
    assert_raises(err) { AcmeAISDK::Internal::Transport::PooledNetRequester::Request }
