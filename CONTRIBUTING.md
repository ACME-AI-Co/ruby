...
Most of the SDK is generated code. Modifications to code will be persisted between generations, but may result in merge conflicts between manual patches and changes from the generator. The generator will never modify the contents of `lib/acme_ai_sdk/helpers/` and `examples/` directory.
...
require_relative "../lib/acme_ai_sdk"
...
```ruby
gem "acme-ai-sdk", git: "https://www.github.com/ACME-AI-Co/ruby"
```

Alternatively, reference local copy of the repo:

```bash
$ git clone -- 'https://www.github.com/ACME-AI-Co/ruby' '<path-to-repo>'
```

```ruby
gem "acme-ai-sdk", path: "<path-to-repo>"
```
